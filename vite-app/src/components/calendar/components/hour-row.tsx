...
const HourRow = ({ hour }: { hour: number }) => {
	...
	return (
		<div
			className='flex flex-col items-center justify-center border-b border-r border-neutral-300 font-semibold text-neutral-500 transition-[height] sm:flex-row dark:border-neutral-600 dark:text-neutral-400'
