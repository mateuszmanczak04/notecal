...
const CreateFirstNote: FC<CreateFirstNoteProps> = ({ courseId }) => {
	...
	return (
		<button
			onClick={handleClick}
			className='flex h-6 shrink-0 items-center justify-center text-nowrap rounded-xl bg-neutral-100 px-4 transition hover:bg-neutral-200 dark:bg-neutral-700 dark:hover:bg-neutral-600'>
